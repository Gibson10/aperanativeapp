...
class GigDetails extends Component {
	...
	// 		this.props.navigation.navigate("CurrentScreen")
			
	// 	}
	// }

	render() {		
		const {gig,visible}=this.props
			...
			<View style={styles.container}>
                ...
                */}
                <View style={styles.details}>
                    ...
                    style={[styles.title2]}>{businessProfile.gigName} </Text></TouchableOpacity>
				...
				<View style={styles.taskDetails}>
					...
					<View style={styles.wages}>
						...
						<Text style={styles.price}>
							${Math.round(businessProfile.hourWage * 0.90)} 
							/hr
						</Text>
					</View>
				...
				<View style={styles.about}>
					...
					<Text style={styles.aboutDetails}>
						{businessProfile.gigDescription}
					</Text>
				</View>
				<View style={styles.about}>
                ...
                <View style={styles.about}>
                <Text style={styles.atitle}>About the location</Text>
                <TouchableOpacity
								onPress={Platform.OS==='ios'?() => Linking.openURL(`maps://app?daddr=${businessProfile.location.lat}+${businessProfile.location.lng}`):
												   () => Linking.openURL(`google.navigation:q=${businessProfile.location.lat}+${businessProfile.location.lng}`)
												}
